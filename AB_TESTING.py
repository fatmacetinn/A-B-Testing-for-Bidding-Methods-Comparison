...
#  Kontrol ve test grubu verilerini analiz edilmesi
...
# Adım 3: Analiz işleminden sonra concat metodunu kullanarak kontrol ve test grubu verilerini birleştirilmesi
...
#  Kontrol ve test grubu için purchase(kazanç) ortalamalarını analiz edilmesi

df.groupby("group").agg({"Purchase": "mean"})



# Adım 1: Hipotez testi yapılmadan önce varsayım kontrollerini yapalım .Bunlar Normallik Varsayımı ve Varyans Homojenliğidir.
